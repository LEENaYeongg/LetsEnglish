...
<body class="w3-light-grey">
	...
	<div class="w3-bar w3-top w3-light-gray w3-right" style="height: 70px;">
		...
		<span class="w3-bar-item w3-center w3-right" style="font-family: Fantasy; font-size:40px;"> 
		...
		<div class="w3-container w3-row">
			...
			<div class="w3-col s8 w3-bar" style="padding-left: 35px;">
				...
				<div style="float: left">
					<c:if test="${empty sessionScope.login }">
						<button
							onclick="location.href='${path}/model2/member/joinForm.me'">회원가입</button>&nbsp;</c:if>
					<c:if test="${!empty sessionScope.login }">
						<button
							onclick="location.href='${path}/model2/member/info.me?id=${sessionScope.login }'">내정보</button>&nbsp;</c:if>
				</div>
				<div style="float: left">
					<c:if test="${empty sessionScope.login }">
						<button
							onclick="location.href='${path}/model2/member/loginForm.me'">로그인</button>
					</c:if>
					<c:if test="${!empty sessionScope.login }">
						<button onclick="location.href='${path}/model2/member/logout.me'">로그아웃</button>
					</c:if>
				</div>
				<br>
